...
class BreadthFirstBot extends SlidingPlayer {
    ...
    public Deque<SlidingMove> Solution(SlidingBoard board) {
      ...
      Deque<BoardNode> boardQueue = new ArrayDeque<BoardNode>();
      BoardNode firstNode = new BoardNode(board);
      boardQueue.add(firstNode);
      ...
      while(true){
        ...
        BoardNode nextBoard = boardQueue.remove();
